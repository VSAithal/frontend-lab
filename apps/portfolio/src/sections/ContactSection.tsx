  ...
  return (
    <div className="rounded-3xl border border-[hsl(var(--border)/0.65)] bg-[hsl(var(--card)/0.9)] p-7 shadow-glow md:p-10">
      ...
      <p className="mt-3 text-[hsl(var(--muted-foreground))]">
        I am currently looking for frontend roles where I can contribute to product
        quality, scalable architecture, and strong user experience.
      </p>
      ...
      <ul className="mt-7 w-full max-w-2xl space-y-3 text-left text-sm md:text-base">
        <li>
          ...
          <Button
            asChild
            variant="link"
            className="h-auto max-w-full whitespace-normal p-0 text-left align-baseline text-[hsl(var(--primary))]"
          >
            <a
              className="break-all underline-offset-4 hover:underline"
              href="mailto:vsagaraithal@gmail.com"
            >
